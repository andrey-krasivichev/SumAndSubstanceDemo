...
@property (nonatomic, readonly, copy) NSArray * _Nullable timeBasedSessionImages DEPRECATED_MSG_ATTRIBUTE("This API is now deprecated and will be removed in an upcoming release.  Usage of this API consumes device resources and does not provide much additional value over standard Audit Images now that the Get Ready Screen is a required component of the ZoOm User Experience.");
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable frontImagesBase64;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable backImagesBase64;
/** ZoOm ID Scan Data. */
...
/**
 * Spacing between characters of the title's subtext and messages during the Identity Document Capture and Review Screens.
 * Default is 0.
 */
 ...
 */
@property (nonatomic, strong) UIImage * _Nullable customImageLowLight DEPRECATED_MSG_ATTRIBUTE("Please configure the cancel button for low light mode by creating a separate ZoomCustomization object, configure .customImage, and apply using setLowLightCustomization(). This customization property will be removed in an upcoming version.");
/**
 ...
 */
@property (nonatomic) BOOL enableTimeBasedSessionImages DEPRECATED_MSG_ATTRIBUTE("This API and ZoomSessionResult.faceMetrics.timeBasedSessionImages are now deprecated and will be removed in an upcoming release.  Usage of these APIs consume device resources and does not provide much additional value over standard Audit Images now that the Get Ready Screen is a required component of the ZoOm User Experience.");
